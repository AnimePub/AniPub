...
DetailsRouter.get("/details/:id", async (req, res) => {
    try {
        ...
        const localAnime = await  AnimeDB.findOne({"_id":animeId},{Genres:1,Synonyms:1,Producers:1,Premiered:1,Aired:1,Duration:1,Status:1,Studios:1,Name:1,ImagePath:1,DescripTion:1,_id:1,MALScore:1,RatingsNum:1,epCount:{$size:"$ep"}})
